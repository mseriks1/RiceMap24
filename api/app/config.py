...
def load_runtime_config() -> RuntimeConfig:
    ...
    cfg = RuntimeConfig(
        ...
        release_version=(os.environ.get("RICEMAP_RELEASE_VERSION", "step9.57-owner-session-header-persistence-fix") or "step9.57-owner-session-header-persistence-fix").strip(),
