...
def load_runtime_config() -> RuntimeConfig:
    ...
    cfg = RuntimeConfig(
        ...
        release_version=(os.environ.get("RICEMAP_RELEASE_VERSION", "step9.49-login-first-header-and-dashboard-access") or "step9.49-login-first-header-and-dashboard-access").strip(),
