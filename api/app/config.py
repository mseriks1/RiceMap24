...
def load_runtime_config() -> RuntimeConfig:
    ...
    cfg = RuntimeConfig(
        ...
        release_version=(os.environ.get("RICEMAP_RELEASE_VERSION", "step9.46-staging-redirect-and-demo-seed-fix") or "step9.46-staging-redirect-and-demo-seed-fix").strip(),
