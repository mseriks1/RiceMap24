...
def load_runtime_config() -> RuntimeConfig:
    ...
    cfg = RuntimeConfig(
        ...
        release_version=(os.environ.get("RICEMAP_RELEASE_VERSION", "step9.47-owner-dashboard-shortcut-navigation-smoothing") or "step9.47-owner-dashboard-shortcut-navigation-smoothing").strip(),
